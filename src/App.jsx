...
import Themes2 from "./components/Themes/ThemesNew";
...
function App() {
  ...
  xl:text-[13.25rem] xl:tracking-[2.0625rem]  "
			...
			{/* Second Section */}
			<section
				className="min-h-fit flex flex-col justify-center items-center scroll-snap-align-start
      mt-8"
				id="about"
			>
				<Event />
				<section id="themes" className="mdHidden">
					<Themes />
				</section>
				<Themes2 data={ThemeData} activeSlide={2} />
			</section>

			{/* Third Section */}
			<section
				className="min-h-fit flex flex-col justify-center items-center mt-8 scroll-snap-align-start
     "
				id="schedule"
			>
				<TimeLine />
			...
			{/* Fourth Section */}
			<section
				className="min-h-fit flex flex-col justify-around items-center gap-6 p-6 mt-8 scroll-snap-align-start"
				id="rules"
			>
				<Rules />
				<ContactUs />
